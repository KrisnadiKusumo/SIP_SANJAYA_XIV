		...
		<div class="layout-page">
			<div class="content-wrapper">
				<div class="container-xxl flex-grow-1 container-p-y">
					<h4 class="fw-bold py-3 mb-4">Detail Buku Paket</h4>
					<div class="row">
						<div class="col-xl">
							<div class="card mb-4">
								...
								<div class="card-body">
									<form id="form-update-buku" method="post" action="<?= site_url('BukuController/updateBuku') ?>" enctype="multipart/form-data">
										<div class="mb-3">
											...
											<input require type="text" readonly value="<?= $buku->jenis_buku?>"  class="form-control" name="jenis_buku" placeholder="Masukkan Kode Buku" />
										</div>
										<div class="mb-3">
